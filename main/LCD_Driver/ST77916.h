...
#define ESP_PANEL_LCD_SPI_CLK_HZ            (80 * 1000 * 1000)   // 80 MHz; must be integer divisor of 80M
...
// RST = -1: reset is driven by TCA9554PWR GPIO expander (EXIO2), not a direct GPIO pin
...
// === LEDC BACKLIGHT (PWM) CONFIGURATION ===
